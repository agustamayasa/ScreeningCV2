...
def get_job_folder_structure(drive, job_position: str):
    """Membuat struktur folder untuk posisi pekerjaan tertentu"""
    try:
        # Buat folder utama "AI Resume Screening"
        ...
        print(f"Error creating job folder structure: {e}")
        return None, None
