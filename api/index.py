...
def analyze_with_gemini(job_desc: str, resume_text: str) -> dict:
    try:
        ...
        {{
            ...
            "kekuatan": "UNTUK BAGIAN KEKUATAN WAJIB FORMATNNYA DIJADIKAN LIST DENGAN ANGKA, 3-4 kekuatan utama kandidat yang relevan dengan posisi (maksimal 200 kata)",
            "kekurangan": "UNTUK BAGIAN KEKURANGAN WAJIB FORMATNNYA DIJADIKAN LIST DENGAN ANGKA, Area yang perlu ditingkatkan atau gap yang ditemukan (maksimal 150 kata)",
