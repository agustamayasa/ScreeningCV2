...
<div align="center">
  ...
  <p>
    <a href="https://screening-cv-2.vercel.app/screening">
      <img src="https://img.shields.io/badge/🚀_COBA_APLIKASI_SEKARANG-4F46E5?style=for-the-badge&logoColor=white&labelColor=818CF8" alt="Coba Aplikasi Langsung" height="50">
    </a>
  </p>
  
  <p>
    <em>✨ Gratis • ⚡ Cepat • 🤖 Didukung AI</em>
  </p>
...
/ (Root Proyek)
├── api/
│   └── index.py            # Backend: Serverless API FastAPI
│
├── app/
│   ├── screening/
│   │   └── page.js         # Frontend: Halaman Dashboard Screening
│   ├── globals.css         # CSS Global & setup Tailwind
│   ├── icon.png            # Favicon
│   ├── layout.js           # Layout root Next.js
│   ├── page.js             # Frontend: Halaman Landing (Homepage)
│   └── page.module.css     # CSS Modules untuk Homepage
│
├── public/
│   ├── templates/
│   │   └── Template_Deskripsi_Pekerjaan.docx # Template JD
│   ├── logo.jpg
│   ├── logo2.png
│   ├── rekruta1.jpg        # Logo utama
│   ├── file.svg
│   ├── globe.svg
│   ├── next.svg
│   ├── vercel.svg
